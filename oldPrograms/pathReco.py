...
histCanvas, stack, legend, histInt = histStack("Outcome of single-photon true events", histList, ntuplePOTsum)
histCanvas2, stack2, legend2, histInt2 = histStack("Outcome of two-photon true events", histList2, ntuplePOTsum)
histCanvas3, stack3, legend3, histInt3 = histStack("Outcome of three-photon true events", histList3, ntuplePOTsum)
...
print(vertexCount, "events passed the vertex check")
print(NCCount, "events passed the reco NC check")
print(fiducialCount, "events passed the fiducial check")
print(noPionCount, "events passed the no pion/proton check")
