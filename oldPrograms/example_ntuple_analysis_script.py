...
# This function takes a histogram as input and sets its x and y axis titles
# and increases its line width
def configureHist(h):
...
# Here we configure each of the histograms we created in lines 46-52
